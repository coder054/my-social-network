...
$(function() {
  ...
  socket.on("userLikedTweet", function(data) {
    ...
    if (userThatHaveTweetLiked !== idOfCurrentLoginUser) {
      console.log("userThatHaveTweetLiked", userThatHaveTweetLiked)
      console.log("idOfCurrentLoginUser", idOfCurrentLoginUser)
      //current
      let html = `
        <a target="_blank" href="/tweet/${tweetId}">
